...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(
                        blank=True, null=True, upload_to="course_thumbnails/%Y/%m/"
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="course",
            index=models.Index(
                fields=["category", "status", "is_published"],
                name="courses_categor_891c5f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="course",
            index=models.Index(
                fields=["rating_average", "enrollment_count"],
                name="courses_rating__7d53c8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="course",
            index=models.Index(
                fields=["price", "is_free", "status"], name="courses_price_ec5b43_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="coursesection",
            index=models.Index(
                fields=["course", "order"], name="course_sect_course__be0a09_idx"
            ),
        ),
    ]
